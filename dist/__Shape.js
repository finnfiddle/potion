...
exports.default = {
  ...
  init: function init() {
    ...
    var enterAttrs = this.getAttrs(enter(datum, index, data));
  ...
  componentWillAppearOrEnter: function componentWillAppearOrEnter(callback) {
    ...
    var startAttrs = enter(datum, index, data);
    ...
    var endPropsForGenerators = this.getPropsForGenerators(this.props);
    var startPropsForGenerators = (0, _assign2.default)({}, this.getPropsForGenerators(startAttrs), endPropsForGenerators);

    var tweener = this.tweenProps(startPropsForGenerators, endPropsForGenerators);
  ...
  componentWillLeave: function componentWillLeave(callback) {
    ...
    var attrs = leave(datum, index, data);
