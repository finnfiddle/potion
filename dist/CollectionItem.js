  ...
  render: function render() {
    ...
    return _react2.default.createElement(
      ...
      _react.Children.map(this.props.children, function (child) {
        return (0, _react.cloneElement)(child, _this.getChildProps(child, _this.props.value));
      })
    );
  },
  getChildProps: function getChildProps(child, value) {
    return (0, _keys2.default)(child.props).reduce(function (acc, key) {
      var prop = child.props[key];
