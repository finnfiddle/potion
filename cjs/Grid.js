(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'its-set', 'd3-v4-grid', './TransitionGroup'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('its-set'), require('d3-v4-grid'), require('./TransitionGroup'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.itsSet, global.d3V4Grid, global.TransitionGroup);
    global.Grid = mod.exports;
  }
})(this, function (exports, _react, _itsSet, _d3V4Grid, _TransitionGroup) {
  'use strict';
