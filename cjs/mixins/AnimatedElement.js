(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'its-set', 'd3-interpolate', 'd3-ease', 'deep-equal', 'array-uniq', './SelectSelf', '../helpers', 'd3-transition'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('its-set'), require('d3-interpolate'), require('d3-ease'), require('deep-equal'), require('array-uniq'), require('./SelectSelf'), require('../helpers'), require('d3-transition'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.itsSet, global.d3Interpolate, global.d3Ease, global.deepEqual, global.arrayUniq, global.SelectSelf, global.helpers, global.d3Transition);
    global.AnimatedElement = mod.exports;
  }
})(this, function (exports, _react, _itsSet, _d3Interpolate, _d3Ease, _deepEqual, _arrayUniq, _SelectSelf2, _helpers) {
  'use strict';
