  ...
  (0, _createClass3.default)(AnimatedElement, [{
    ...
    value: function applyDerivedAttrsToSelection(props, datum, selection, shouldGetDatum) {
      ...
      this.derivedAttrNames.forEach(function (key) {
        _this5.applyAttrsToSelection((0, _defineProperty3.default)({}, key, _this5.getDerivationFunction(key, props, shouldGetDatum)(datum)), selection);
      });
    }
  }, {
    key: 'getDerivedAttrs',
    value: function getDerivedAttrs(props, datum, shouldGetDatum) {
      ...
      return this.derivedAttrNames.reduce(function (acc, key) {
        return (0, _assign2.default)({}, acc, (0, _defineProperty3.default)({}, key, _this6.getDerivationFunction(key, props, shouldGetDatum)(datum)));
      }, {});
    }
  }, {
    ...
    value: function applyDerivedAttrs(toDatum, props, selection, shouldGetDatum) {
      ...
      this.derivedAttrNames.forEach(function (key) {
        selection.attr(key, _this7.getDerivationFunction(key, props, shouldGetDatum)(toDatum));
      });
    }
  }, {
    ...
    value: function tweenDerivedAttrs(fromDatum, toDatum, props, transition, shouldGetDatum) {
      ...
      this.derivedAttrNames.forEach(function (key) {
        _this8.attrTween(key, fromDatum, toDatum, transition, _this8.getDerivationFunction(key, props, shouldGetDatum));
      });
    }
  }, {
    key: 'attrTween',
