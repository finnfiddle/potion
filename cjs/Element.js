  ...
  (0, _createClass3.default)(Element, [{
        ...
        case UPDATE:
          {
            ...
            if (!datumHasChanged) {
              attr = (0, _util.diff)(attr, this.currentAttr);
              style = (0, _util.diff)(style, this.currentStyle);
            }
            return {
              attr: attr,
              style: style,
    ...
    value: function evaluateProps(props) {
      return (0, _keys2.default)(props).reduce(function (acc, key) {
        return (0, _extends5.default)({}, acc, (0, _defineProperty3.default)({}, key, (0, _util.isFunction)(props[key]) ? props[key](props) : props[key]));
      }, {});
    }
  }, {
    key: 'draw',
    ...
    value: function solidify() {
      ...
      this.setState({
        el: (0, _react.cloneElement)(this.el.toReact(), (0, _util.bindMouseEvents)(this.props))
      }, callback);
    }
  }, {
    key: 'animate',
