  ...
  (0, _createClass3.default)(Group, [{
    ...
    value: function renderChildren() {
      ...
      return _react.Children.map(children, function (child) {
        ...
        var props = child !== null && (0, _helpers.isFunction)((0, _utilsDeepGet2.default)(child, 'type')) ? (0, _assign2.default)({ datum: datum, data: data, index: index, enterDatum: enterDatum, exitDatum: exitDatum }, child.props) : child.props;
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        (0, _extends3.default)({}, this.state, { style: style }, (0, _helpers.bindMouseEvents)(this.props)),
        this.renderChildren()
      );
    }
  }]);
