(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'd3-shape', 'its-set', './TransitionGroup'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('d3-shape'), require('its-set'), require('./TransitionGroup'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.d3Shape, global.itsSet, global.TransitionGroup);
    global.Pie = mod.exports;
  }
})(this, function (exports, _react, _d3Shape, _itsSet, _TransitionGroup) {
  'use strict';
