...
var Rect = function (_Element) {
  ...
  function Rect() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = Rect.__proto__ || (0, _getPrototypeOf2.default)(Rect)).call.apply(_ref, [this].concat(args))), _this), _this.defaultComponent = 'rect', _temp), (0, _possibleConstructorReturn3.default)(_this, _ret);
  }
