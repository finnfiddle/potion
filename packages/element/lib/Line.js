...
var Line = function (_Element) {
  ...
  function Line() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = Line.__proto__ || (0, _getPrototypeOf2.default)(Line)).call.apply(_ref, [this].concat(args))), _this), _this.defaultComponent = 'line', _temp), (0, _possibleConstructorReturn3.default)(_this, _ret);
  }
