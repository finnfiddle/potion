...
var Ribbon = function (_Element) {
  ...
  function Ribbon() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = Ribbon.__proto__ || (0, _getPrototypeOf2.default)(Ribbon)).call.apply(_ref, [this].concat(args))), _this), _this.defaultComponent = 'path', _temp), (0, _possibleConstructorReturn3.default)(_this, _ret);
  }
