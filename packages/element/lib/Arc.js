...
var Arc = function (_Element) {
  ...
  function Arc() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = Arc.__proto__ || (0, _getPrototypeOf2.default)(Arc)).call.apply(_ref, [this].concat(args))), _this), _this.defaultComponent = 'path', _temp), (0, _possibleConstructorReturn3.default)(_this, _ret);
  }
